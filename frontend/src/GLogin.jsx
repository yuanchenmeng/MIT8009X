...
export default function Login() {
  ...
  const handleClick = () => {
    ...
    //const callbackUrl = `${window.location.origin}/users/auth/google_oauth2/callback`;
    const googleClientId = "541322469822-jrghpm6vbtm1sccu71ksurp0qc9l0bdk.apps.googleusercontent.com";
    const targetUrl = `https://accounts.google.com/o/oauth2/auth?redirect_uri=${encodeURIComponent(
      callbackUrl
    )}&response_type=token&client_id=${googleClientId}&scope=openid%20email%20profile`;
    //const targetUrl = "https://accounts.google.com/o/oauth2/v2/auth?client_id=731669561286-gvu6im571oks2ap0fu2s06hafgf4us31.apps.googleusercontent.com&redirect_uri=http://localhost:3000/callback&response_type=token&scope=profile";
